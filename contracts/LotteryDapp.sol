...
contract LotteryDapp is Ownable {
  ...
  constructor(uint256 _setvicePercent) {
    servicePercent = _setvicePercent;
  }
  ...
  function createLottery(
    ...
    require(expiresAt > currentTime(), 'expiresAt cannot be less than the future');
  ...
  function buyTicket(uint256 id, uint256 luckyNumberId) public payable {
    ...
    require(msg.value >= lotteries[id].ticketPrice, 'Insufficient ethers to buy the ticket');
